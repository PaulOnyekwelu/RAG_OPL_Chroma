...
def init_rag(index_name, load_type="file", file_path=None, query=None):
    document = (
...
if __name__ == "__main__":
    init_rag("internation-students-uk", file_path="./international_students_working_in_the_uk_during_your_studies_2015-16_booklet.pdf")
